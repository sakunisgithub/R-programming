...
\hspace{1cm} In a competitive examination, a student attempts 20 independent multiple-choice questions. Each question has four options, only one of which is correct, and the student answers each question randomly. The probability of answering any question correctly is therefore $1/4$. Let $X$ denote the number of correct answers of the student. 
\begin{enumerate}[(i)]
...
\begin{itemize}
\item[\scalebox{2.0}{\twemoji{keycap: 1}}] \hspace{0.1cm} In the given set-up, $X$ is said to have a Binomial distribution with parameters $n = 20$ and $p = \text{probability of success} = \dfrac{1}{4}$. \\[0.2em]

We write $$X \sim \text{Binomial}\left(20, \dfrac{1}{4}\right).$$

\item[\scalebox{2.0}{\twemoji{keycap: 2}}] \hspace{0.1cm} The Probability Mass Function of $X$ is given by 
\begin{align*}
P[X = x] = \binom{20}{x} \left(\dfrac{1}{4}\right)^x \left(\dfrac{3}{4}\right)^{20-x}; \,\, x = 0, 1, 2, \ldots, 20.
\end{align*}

Thus, the probability that the student answers exactly $6$ questions correctly will be
\begin{align*}
P[X = 6] &= \binom{20}{6} \left(\dfrac{1}{4}\right)^6 \left(\dfrac{3}{4}\right)^{20-6} \\[0.4em]
&= \binom{20}{6} \left(\dfrac{1}{4}\right)^6 \left(\dfrac{3}{4}\right)^{14} \\[0.4em]
&\approx 0.182.
\end{align*}

\item[\scalebox{2.0}{\twemoji{keycap: 3}}] \hspace{0.1cm} If $X \sim \text{Binomial}\left(20, \dfrac{1}{4}\right)$, $E[X] = 20 \cdot \dfrac{1}{4} = 5$. So expected number of correct answers of the student is $5$.
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{CDF_F} \hlkwb{<-} \hlkwd{pbinom}\hldef{(}\hlkwc{q} \hldef{=} \hlnum{0}\hlopt{:}\hlnum{20}\hldef{,} \hlkwc{size} \hldef{=} \hlnum{20}\hldef{,} \hlkwc{prob} \hldef{=} \hlnum{1}\hlopt{/}\hlnum{4}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\fontsize{25}{20} \ding{46}} {\setlength{\spaceskip}{1em plus 0.5em minus 0.5em} \fontsize{17}{20}\myfont Most of the sample values are in between 1 and 13. Values in the tail have a very small probability mass, so with n = 10000 only, it is unlikely to observe them and exactly that has happened to be the case. \par}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{theo_prob} \hlkwb{<-} \hlkwd{dbinom}\hldef{(}\hlkwc{x} \hldef{=} \hlnum{0}\hlopt{:}\hlnum{20}\hldef{,} \hlkwc{size} \hldef{=} \hlnum{20}\hldef{,} \hlkwc{prob} \hldef{=} \hlnum{1}\hlopt{/}\hlnum{4}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
% Date and time: Fri, Jun 05, 2026 - 21:30:33
...
{\fontsize{25}{20} \ding{46}} {\setlength{\spaceskip}{1em plus 0.5em minus 0.5em} \fontsize{17}{20}\myfont Empirical probabilities very much agree with theoretical probabilities. \par}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{n} \hlkwb{<-} \hlnum{100}\hldef{; u} \hlkwb{<-} \hlkwd{runif}\hldef{(n); CDF_F} \hlkwb{<-} \hldef{(}\hlnum{1}\hlopt{:}\hlnum{6}\hldef{)} \hlopt{/} \hlnum{6}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{kframe}
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Fri, Jun 05, 2026 - 21:30:43
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{Table 2} 
...
{\fontsize{25}{20} \ding{46}} {\setlength{\spaceskip}{1em plus 0.5em minus 0.5em} \fontsize{17}{20}\myfont Observed relative frequencies are consistent with theoretical probability. \par}
