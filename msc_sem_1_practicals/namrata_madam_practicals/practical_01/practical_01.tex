...
After the last iteration, value of $f$ is $8.88 \times 10^{-15} \approx 0$ and that of $g$ is $6.66 \times 10^{-15} \approx 0$. So we consider $(x, y) = (0, 0)$ as our solution to the given system of non-linear equations.
