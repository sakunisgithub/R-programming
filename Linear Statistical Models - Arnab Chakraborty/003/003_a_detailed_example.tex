...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fit}\hlopt{$}\hlstd{fitted.values}
\end{alltt}
\begin{verbatim}
##         1         2         3         4         5         6 
...
\begin{alltt}
\hlkwd{plot}\hlstd{(length} \hlopt{~} \hlstd{weight,} \hlkwc{data} \hlstd{= our_data)}
\hlkwd{abline}\hlstd{(fit}\hlopt{$}\hlstd{coefficients)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{all_data}\hlopt{$}\hlstd{lab} \hlkwb{=} \hlkwd{factor}\hlstd{(all_data}\hlopt{$}\hlstd{lab)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{class}\hlstd{(all_data)}
\end{alltt}
\begin{verbatim}
## [1] "data.frame"
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(all_data}\hlopt{$}\hlstd{weight)}
\end{alltt}
\begin{verbatim}
## [1] "numeric"
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(all_data}\hlopt{$}\hlstd{length)}
\end{alltt}
\begin{verbatim}
## [1] "numeric"
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(all_data}\hlopt{$}\hlstd{lab)}
\end{alltt}
\begin{verbatim}
## [1] "factor"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(length} \hlopt{~} \hlstd{weight, all_data,} \hlkwc{col} \hlstd{= lab)}
\end{alltt}
\end{kframe}
